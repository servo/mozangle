...
pub const EGL: Data = Data {
    ...
    os_libs: &[
        "advapi32", "comdlg32", "d3d9", "dbghelp", "delayimp", "dnsapi", "dxguid", "gdi32",
        "kernel32", "msimg32", "odbc32", "odbccp32", "ole32", "oleaut32", "setupapi", "shell32",
        "shlwapi", "user32", "usp10", "uuid", "version", "wininet", "winmm", "winspool", "ws2_32",
    ],
};
